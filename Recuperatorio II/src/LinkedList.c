...
/*
 *
 * 3) Asignar tiempos: Se deberá hacer uso de la función map. la cual recibirá el linkedlist
 *  y una función que asignará a la película un valor de
 * duración entre 100 y 240 minutos calculado de manera aleatoria
 * se mostrará por pantalla el mismo.
 */
